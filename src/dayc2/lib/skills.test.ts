...
describe('validateSkillItems', () => {
  ...
  it('canCopyAble is true when able has items and no conflicts', () => {
  ...
  it('canCopyUnable is true when unable has items and no conflicts', () => {
  ...
  it('formatCopyText returns comma-separated items', () => {
    const result = validateSkillItems({ able: '17, 12, 14', unable: '' });
